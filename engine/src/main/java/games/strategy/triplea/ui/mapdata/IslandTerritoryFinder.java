...
class IslandTerritoryFinder {
  ...
  private static Set<String> filterSeaTerritories(final Set<String> territoryNames) {
    return filterTerritories(territoryNames, IslandTerritoryFinder::isTerritoryNameIndicatingWater);
  }

  private static Set<String> filterNotSeaTerritories(final Set<String> territoryNames) {
    return filterTerritories(
        territoryNames, Predicate.not(IslandTerritoryFinder::isTerritoryNameIndicatingWater));
  }
  ...
  static boolean isTerritoryNameIndicatingWater(final String territoryName) {
    return territoryName.endsWith("Sea Zone") || territoryName.startsWith("Sea Zone");
  }
}
